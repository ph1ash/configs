...
"use strict";var Router=require("./routers/Router.js"),msg=require("../utils/msg")("panel_app"),globals=require("../../../src/globals"),sendMessageToBackground=msg.sendMessageToBackground;window.t=chrome.i18n.getMessage,window.App={GHOSTERY_DOMAIN:globals.GHOSTERY_DOMAIN},new Router,sendMessageToBackground("ping","engaged");

},{"../../../src/globals":52,"../utils/msg":22,"./routers/Router.js":4}],2:[function(require,module,exports){
'use strict';
...
var Collections = {
	...
	BlockingCategories: Backbone.Collection.extend({
		...
		buildCollectionData: function (trackerList, selectedAppIds, pageUnblocks, pageBlocks, showSrcs, language) {
			var categories = {},
			    categoryName,
			    categoryArray = [];
	...
	BlockingTrackers: Backbone.Collection.extend({
		...
		setShowSrc: function (showSrcs) {
			var count = 0;
			this.models.forEach(model => {
				model.set('showSrcs', showSrcs);
				count++;
			});
			return count;
		},
...
},{"../../utils/msg":22,"../models/Models":3,"backbone":41,"underscore":50}],3:[function(require,module,exports){
'use strict';
...
var Models = {
	...
	BlockingTracker: ParentModel.extend({
		defaults: {
			...
			panel_tracker_signin_teaser: t('panel_tracker_signin_teaser')
		},
		idAttribute: 'name'
	}),
...
},{"backbone":41}],4:[function(require,module,exports){
'use strict';
...
},{"../../../templates/precompiled/account_success":24,"./ParentView":19,"jquery":47}],8:[function(require,module,exports){
'use strict';
...
var ParentView = require('./ParentView'),
    ...
    log = common.log,
    BROWSER_NAME = common.browserInfo().name;
...
var BlockingTracker = ParentView.extend({
	...
	events: {
		...
		'click .trk-signin-teaser span': 'clickSignIn',
		'click a': 'clickLink'
	},
	...
	render: function (trackers, index) {
		this.setElement(trackers.$('div.blocking-trk').eq(index));
		this.template_more = trackers.template_more;
	...
	updateShowSrcs: function () {
		var showSrcs = this.model.get('showSrcs');

		this.$('.trk-srcs-title, .trk-srcs').css('display', 'none');
		this.$('.trk-signin-teaser').css('display', 'none');
		if (showSrcs === true) {
			this.$('.trk-srcs-title, .trk-srcs').css('display', '');
		} else if (showSrcs === false) {
			this.$('.trk-signin-teaser').css('display', '');
		}
	},
...
},{"../../../../src/common":51,"../vendor/clamp.custom.js":5,"./ParentView":19,"foundation":40,"jquery":47}],11:[function(require,module,exports){
'use strict';
...
},{"../../../templates/precompiled/blocking_tracker":26,"../../../templates/precompiled/blocking_tracker_more":27,"./BlockingTracker":10,"./ParentView":19,"underscore":50}],12:[function(require,module,exports){
'use strict';
...
var BlockingView = ParentView.extend({
	...
	initialize: function (options) {
		...
		this.listenTo(this.model, 'change:logged_in change:show_tracker_urls', this.updateShowSrcs);
		this.listenTo(this.model, 'change:logged_in change:is_validated', this.updatedSignedInState);

		this.render();

		this.model.trigger('change:toggle_individual_trackers change:paused_blocking change:sitePolicy change:is_validated');
	...
	updateTrackers: function () {
		var selectedAppIds = this.model.get('selected_app_ids') || {},
		    ...
		    showSrcs = this.getShowSrcValue();

		this.categoriesView.collection.buildCollectionData(trackerList, selectedAppIds, pageUnblocks, pageBlocks, showSrcs, this.model.get('language'));
	...
	updateShowSrcs: function () {
		var showSrcs = this.getShowSrcValue();
		this.categoriesView.views.forEach(category => {
			category.trackersView.collection.setShowSrc(showSrcs);
		});
	},
	updatedSignedInState: function () {
		var logged_in = this.model.get('logged_in'),
		    is_validated = this.model.get('is_validated');
		if (logged_in && is_validated) {
			this.$('.blocking-trackers').addClass('show-warnings');
			$('.tooltip.warning-tooltip').css('opacity', 0.75);
		} else {
			this.$('.blocking-trackers').removeClass('show-warnings');
			$('.tooltip.warning-tooltip').css('opacity', 0);
		}
	},
	getShowSrcValue: function () {
		var logged_in = this.model.get('logged_in'),
		    show_tracker_urls = this.model.get('show_tracker_urls');
	...
	stickyHeaders: {
		...
		refresh: function () {
			if (BROWSER_NAME === 'firefox' || !this._$wrapperEl) {
				return;
			}
...
},{"../../../../src/common":51,"../../../templates/precompiled/blocking_view":28,"../collections/Collections":2,"./BlockingCategories":8,"./ParentView":19,"jquery":47}],13:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":51,"../../../templates/precompiled/create_account_view":29,"./ParentView":19,"jquery":47}],14:[function(require,module,exports){
'use strict';

var $ = require('jquery'),
    ParentView = require('./ParentView'),
    html = require('../../../templates/precompiled/forgot_password'),
    log = require('../../../../src/common').log;
...
},{"../../../../src/common":51,"../../../templates/precompiled/forgot_password":30,"./ParentView":19,"jquery":47}],15:[function(require,module,exports){
(function (global){
'use strict';
...
var ParentView = require('./ParentView'),
    ...
    browserName = (0, _common.browserInfo)().name;
...
var HeaderView = ParentView.extend({
	...
	clickSignInVerify: function () {
		if (!this.model.get('logged_in')) {
			...
			this.sendMessage('sendVerificationEmail').then(data => {
				...
				(0, _common.log)('SendVerificationEmail Error', err);
			});
		}
	},
	...
	clickBrokenPage: function () {
		this.sendMessage('getSiteData').then(data => {
			...
			(0, _common.log)("Error gathering page data");
		});
		this.$('#header-dropdown').foundation('close');
	},
	...
	clickSignOut: function () {
		...
		this.sendMessage('setLoginInfo', {}).then(data => {
			...
			(0, _common.log)('HeaderView clickSignOut setLoginInfo returned with an error', err);
		});
	},
...
},{"../../../../src/common":51,"../../../templates/precompiled/header_view":32,"./ParentView":19,"foundation":40,"jquery":47}],16:[function(require,module,exports){
'use strict';
...
},{"../../../templates/precompiled/help_view":33,"./ParentView":19,"jquery":47}],17:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":51,"../../../templates/precompiled/login_view":35,"./ParentView":19,"jquery":47}],18:[function(require,module,exports){
(function (global){
'use strict';
...
var PanelView = ParentView.extend({
	...
	events: {
		...
		'click .modal-button-container .update-dismiss': 'clickDismissUpdatedModal',
		...
		'click #updated-modal .modal-button-container .create-account': 'upgradeCreateAccountPing',
		...
		'click .callout-text .tracker-map-sign-in': 'trackerMapSigninPing',
		'click .callout-text .alerts-sign-in': 'alertsSigninPing',
	...
	initialize: function (options) {
		...
		this.listenTo(this.model, 'change:logged_in', this.updateUpgradeModal);
	...
	renderModal: function () {
		var ghostrank = this.model.get('ghostrank'),
		    logged_in = this.model.get('logged_in'),
		    account_dismissed = this.model.get('account_dismissed'),
		    upgrade_dismissed = this.model.get('upgrade_dismissed'),
		    is_second = this.model.get('is_second') || false,
		    is_third = this.model.get('is_third') || false;
		if (!upgrade_dismissed) {
			this.templateUpdated = this.templateUpdated || require('../../../templates/precompiled/updated_modal');
			this.renderModalHelper(this.templateUpdated(this.model.toJSON()));
			this.setModalLocation(ghostrank === 2 ? 'first' : '');
		} else if (ghostrank === 2) {
			this.setModalLocation('first');
		...
		} else if (!account_dismissed && !logged_in) {
			if (is_second) {
				...
				this.setModalLocation('third');
			} else {
				this.templateAccount = this.templateAccount || require('../../../templates/precompiled/account_modal');
				this.renderModalHelper(this.templateAccount(this.model.toJSON()));
				this.setModalLocation('');
				this.$('#ghostrank-modal .modal-title').text(t('panel_modal_ghostrank_title'));
			}
		} else {
			this.$('#ghostrank-modal').foundation('close');
		}

		if (ghostrank === 2 && !upgrade_dismissed) {} else {}
	},
	...
	setModalLocation: function (position) {
		setTimeout(() => {
			$('.location-container').removeClass('first second third').addClass(position);
		}, 100);
	},
	...
	updateUpgradeModal: function () {
		var logged_in = this.model.get('logged_in');

		if (logged_in) {
			this.$('#ghostrank-modal').addClass('logged-in');
		} else {
			this.$('#ghostrank-modal').removeClass('logged-in');
		}
	},
	...
	clickGhostrankOptIn: function () {
		this.model.set('is_second', true);
		this.model.set('ghostrank', 1);
		this.model.save();
	...
	clickMetricsOptIn: function () {
		this.model.set('is_second', false);
		this.model.set('is_third', true);
		this.model.set('enable_metrics', 1);
		this.model.save();
		this.renderModal();
	},
	clickMetricsOptOut: function () {
		this.model.set('is_second', false);
		this.model.set('is_third', true);
		this.model.set('enable_metrics', 0);
		this.model.save();
		this.renderModal();
	},
	clickDismissAccountModal: function () {
		this.model.set('is_second', false);
		this.model.set('is_third', false);
		this.model.set('account_dismissed', true);
		this.model.save();
	},
	clickDismissUpdatedModal: function () {
		this.model.set('is_second', true);
		this.model.set('upgrade_dismissed', true);
		this.model.save();
	},
	...
	upgradeCreateAccountPing: function () {
		this.sendMessage('ping', 'create_upgrade');
	},
	...
	alertsSigninPing: function (e) {
		e.preventDefault();
		this.sendMessage('ping', 'sign_in_alert');
	},
	trackerMapSigninPing: function (e) {
		e.preventDefault();
		this.sendMessage('ping', 'sign_in_scan');
	},
...
},{"../../../templates/precompiled/account_modal":23,"../../../templates/precompiled/ghostrank_modal":31,"../../../templates/precompiled/learn_more_modal":34,"../../../templates/precompiled/metrics_modal":36,"../../../templates/precompiled/updated_modal":39,"../../utils/msg":22,"../models/Models":3,"./AccountSuccessView":7,"./CreateAccountView":13,"./ForgotPasswordView":14,"./HeaderView":15,"./HelpView":16,"./LoginView":17,"./ParentView":19,"./SettingsView":20,"./SummaryView":21,"foundation":40,"jquery":47,"underscore":50}],19:[function(require,module,exports){
'use strict';
...
},{"../../utils/msg":22,"backbone":41}],20:[function(require,module,exports){
(function (global){
'use strict';
...
var _ = require('underscore'),
    ...
    common = require('../../../../src/common'),
    log = common.log,
    browserInfo = common.browserInfo,
...
var SettingsView = ParentView.extend({
	...
	toggleShareData: function () {
		this.model.set('ghostrank', $('#settings-share-data')[0].checked ? 1 : 0);
		this.model.save();
	},
	updateShareData: function () {
		$('#settings-share-data')[0].checked = this.model.get('ghostrank') === 1;
	},
...
},{"../../../../src/common":51,"../../../templates/precompiled/settings_view":37,"./ParentView":19,"foundation":40,"jquery":47,"moment/min/moment-with-locales.min.js":48,"underscore":50}],21:[function(require,module,exports){
'use strict';
...
var SummaryView = ParentView.extend({
	...
	initialize: function (options) {
		...
		this.listenTo(this.model, 'change:sitePolicy', this.updateSitePolicy);
		this.listenTo(this.model, 'change:paused_blocking', this.updateGhosteryPaused);
		this.listenTo(this.model, 'change:logged_in change:is_validated', this.updateTrackerCountAlert);
		this.listenTo(this.model, 'change:cta_status', this.updateCTAStatus);

		this.model.set('donutAnimationDuration', 750);

		this.render();

		this.model.trigger('change:trackerCategories change:trackerList change:pageHost change:categoriesDonutData change:trackerCounts change:cta_status change:sitePolicy change:paused_blocking');
		setTimeout(() => {
	...
	render: function () {
		var name = window.performance.now();
		window.performance.mark("begin" + name);
		...
		window.performance.measure("measure" + name, "begin" + name, "end" + name);
		this.sendMessage("timing", window.performance.getEntriesByName("measure" + name)[0].duration);
	...
	updateTrackerCountAlert: function () {
		...
		if (alertCounts.total) {
			...
			} else if (alertCounts.compatibility) {
				this.$('.tracker-count-alerts').css('display', '');
				this.$('.tracker-count-alerts .count').text(alertCounts.compatibility);
				this.$('.tracker-count-alerts .text').text(alertCounts.compatibility === 1 ? t('summary_alert') : t('summary_alerts'));
			}
			...
			} else if (logged_in && is_validated) {
				if (BROWSER_NAME === 'edge') {
			...
			} else if (this.model.get('logged_in')) {
				this.customEvents.trigger('setNotification', {
					classes: 'needs-reload hideous',
					text: t('panel_verify_to_see')
				});
			} else {
				this.customEvents.trigger('setNotification', {
					classes: 'needs-reload hideous',
					text: t('panel_sign_in_to_see')
				});
			}
		} else {
	...
	updateCTAStatus: function () {
		var cta_status = this.model.get('cta_status'),
		    alertCounts = this.model.get('alertCounts') || {};

		if (alertCounts.total && alertCounts.total > 0) {
			this.updateTrackerCountAlert();
		} else if (cta_status && cta_status.CTAs && !cta_status.CTAs.mapthesetrackers) {
			this.$('.map-trackers').hide();
		}
	},
	...
	clickMapTheseTrackers: function () {
		...
		if (!logged_in) {
			this.customEvents.trigger('setNotification', {
				classes: 'needs-reload hideous',
				text: t('panel_sign_in_trackermap')
			});
		} else if (!is_validated) {
			this.customEvents.trigger('setNotification', {
				classes: 'needs-reload hideous',
				text: t('panel_verify_trackermap')
			});
		} else {
			this.sendMessage('ping', 'live_scan');
			this.sendMessage("openTrackerMap", this.model.get('pageUrl'));
			window.close();
		}
	},
...
},{"../../../../src/common":51,"../../../templates/precompiled/summary_view":38,"../vendor/jquery.animateNumber.js":6,"./BlockingView":12,"./ParentView":19,"d3":44,"jquery":47,"underscore":50}],22:[function(require,module,exports){
'use strict';
...
},{"../../../src/common":51}],23:[function(require,module,exports){
"use strict";module.exports=function(n){var l,c="";return c+='<div id="account-modal">\n\t<div class="modal-title">'+(null==(l=t("panel_modal_account_title"))?"":l)+"</div>\n\t<p>"+(null==(l=t("panel_modal_account_subtitle_1"))?"":l)+"</p>\n\t<ol>\n\t\t<li>"+(null==(l=t("panel_modal_account_bullet_1"))?"":l)+"</li>\n\t\t<li>"+(null==(l=t("panel_modal_account_bullet_2"))?"":l)+"</li>\n\t\t<li>"+(null==(l=t("panel_modal_account_bullet_3"))?"":l)+"</li>\n\t</ol>\n\t<p>"+(null==(l=t("panel_modal_account_subtitle_2"))?"":l)+'</p>\n\t<div class="modal-button-container">\n\t\t<button class="button account-dismiss create-account">\n\t\t\t'+(null==(l=t("panel_modal_account_button_create_account"))?"":l)+'\n\t\t</button>\n\t\t<div class="links">\n\t\t\t<a class="account-dismiss sign-in">'+(null==(l=t("panel_modal_account_button_sign_in"))?"":l)+'</a>\n\t\t\t<a class="account-dismiss no-thanks">'+(null==(l=t("panel_modal_account_button_maybe_later"))?"":l)+'</a>\n\t\t</div>\n\t</div>\n\t<div class="location-container">\n\t\t<svg class="location-circles" height="8" width="40">\n\t\t\t<circle class="first-circle" cx="4" cy="4" r="4" stroke="none" fill="#d8d8d8" />\n\t\t\t<circle class="second-circle" cx="18" cy="4" r="4" stroke="none" fill="#d8d8d8" />\n\t\t\t<circle class="third-circle" cx="32" cy="4" r="4" stroke="none" fill="#d8d8d8" />\n\t\t</svg>\n\t</div>\n</div>\n'};
...
"use strict";module.exports=function(l){var n,d="";return d+='<div id="updated-modal">\n\t<div class="modal-title">'+(null==(n=t("panel_modal_upgrade_title"))?"":n)+'</div>\n\t<ul class="updated">'+(null==(n=t("panel_modal_upgrade_subtitle_1"))?"":n)+"\n\t\t<li>"+(null==(n=t("panel_modal_upgrade_bullet_1"))?"":n)+"</li>\n\t\t<li>"+(null==(n=t("panel_modal_upgrade_bullet_2"))?"":n)+"</li>\n\t\t<li>"+(null==(n=t("panel_modal_upgrade_bullet_3"))?"":n)+"</li>\n\t\t<li>"+(null==(n=t("panel_modal_upgrade_bullet_4"))?"":n)+'</li>\n\t</ul>\n\t<div class="modal-button-container">\n\t\t<button class="button update-dismiss account-dismiss get-started">\n\t\t\t'+(null==(n=t("panel_modal_upgrade_continue"))?"":n)+'\n\t\t</button>\n\t\t<div class="account-blurb hide-logged-in">\n\t\t\t'+(null==(n=t("panel_modal_upgrade_account_blurb"))?"":n)+'\n\t\t</div>\n\t</div>\n\t<div class="location-container">\n\t\t<svg height="8" width="22">\n\t\t\t<circle class="first-circle" cx="4" cy="4" r="4" stroke="none" fill="#d8d8d8" />\n\t\t\t<circle class="second-circle" cx="18" cy="4" r="4" stroke="none" fill="#d8d8d8" />\n\t\t</svg>\n\t</div>\n</div>\n'};
...
},{"jquery":47,"underscore":50}],42:[function(require,module,exports){
...
},{"base64-js":42,"ieee754":45,"isarray":46}],44:[function(require,module,exports){
...
},{"buffer":43,"ua-parser-js":49}],52:[function(require,module,exports){
'use strict';
