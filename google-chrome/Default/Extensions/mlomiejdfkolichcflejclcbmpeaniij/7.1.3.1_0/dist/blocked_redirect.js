...
(function BlockedRedirect(window, document, undefined) {
	...
	function setupDocument(blockedRedirectData) {
		...
		document.getElementById('action_always').firstChild.title = translations.blocked_redirect_action_always_title;
		document.getElementById('action_through_once').firstChild.title = translations.blocked_redirect_action_through_once_title;
	...
	window.addEventListener('load', function () {
		...
		var button1 = document.getElementById("action_through_once");
		if (button1) {
		...
		var button2 = document.getElementById("action_always");
		if (button2) {
