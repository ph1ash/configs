...
var msg = require('./utils/msg')('resource_timing'),
    log = msg.log;

msg.onMessage.addListener(function (request, sender, sendResponse) {
  if (request.name === "getResourceTiming") {
    msg.sendMessageInPromise('onGetResourceTiming', {
      details: request.message.details,
      resourceTiming: window.performance.getEntriesByName(request.message.details.url)[0] || false
    }).catch(err => {
      log('resource_timing sendMessageInPromise error', err);
    });
  }
});
...
},{"../../../src/common":8}],3:[function(require,module,exports){
...
},{"buffer":4,"ua-parser-js":7}]},{},[1])

//# sourceMappingURL=resource_timing.js.map
